	...
	return (
		...
		>
			...
			<div className="flex flex-wrap">
				<div className="text-white text-xl text-center md:text-left px-10 w-full md:w-1/2 mb-4 self-center">
					<h1>
					...
					<div className="text-white">
						...
						<a
							...
							aria-label="coderank"
						>
							<i className="bx text-5xl mr-10 bx-code-alt hover:text-primaryHighlight" />
						</a>
					</div>
				</div>
				<div className="w-full md:w-1/2 mb-5">
					<form onSubmit={handleForm} className="w-3/4 mx-auto" autoComplete="off">
